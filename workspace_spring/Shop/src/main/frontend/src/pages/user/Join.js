        ...
        <table className='join-table'>
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div className='inline-input'>
                  <input value={joinData.post} className='form-control' type='text' placeholder='우편번호' readOnly={true} onClick={handleClick} name='post' onChange={(e) => {changeJoinData(e)}}/>
            ...
            <tr>
              <td></td>
              <td>
                <input value={joinData.memAddr} className='form-control' type='text' placeholder='주소' readOnly={true} onClick={handleClick} name='memAddr' onChange={(e) => {changeJoinData(e)}}/>
              </td>
            </tr>
            <tr>
              <td></td>
              <td>
                <input className='form-control' type='text' placeholder='상세주소'  name='addrDetail' onChange={(e) => {changeJoinData(e)}}/>
              </td>
            </tr>
            <tr>
              <td>이메일</td>
              <td>
                <div className='inline-select'>
                  <input className='form-control' type='text' ref={email_1} name='memEmail' onChange={(e) => {changeJoinData(e)}}/>
